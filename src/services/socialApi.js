  ...
  return [
    {
      ...
      summary: "La escena tropical de la Región de La Araucanía se prepara para un estreno importante. La Banda Bruna anunció el rodaje de su segundo videoclip para su tema original \"Ahogado en un bar\" en el icónico Bar Buenos Aires en la ciudad de Temuco.",
      content: `La escena tropical de la Región de La Araucanía se prepara para un importante estreno. La Banda Bruna anunció el rodaje de su segundo videoclip, para su nuevo tema original «Ahogado en un bar». El proyecto, que se registrará bajo el ritmo y la energía de la cumbia tropical, tendrá como escenario principal las instalaciones del icónico Bar Buenos Aires en la ciudad de Temuco, lo que promete capturar la atmósfera perfecta para la canción. La producción visual estará en manos de la reconocida Agencia CK, lo que asegura un estándar de calidad técnica y artística de primer nivel para la escena local.
